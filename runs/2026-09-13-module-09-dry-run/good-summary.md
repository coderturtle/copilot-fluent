# Constructed "good" summary - Molly Jensen, Q3 2027 (for Dalton's file)

*Simulation only. This is a constructed stand-in summary built by hand for this dry run, not a real
Copilot output. Kellerman & Castle operates in no real regulatory regime; nothing here is calibrated
to one. Reusing this format against a real client's real document is your own regulated activity,
not something this workshop can vouch for.*
