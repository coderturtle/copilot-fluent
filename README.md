...
> **Current status: Module 06 is the highest module with real content.** Modules 01 through 06 have a real exercise and gate; Modules 07-09 are still design-complete skeletons with no authored exercise yet. Watch `docs/build-log/` for progress, or reach out using the contact method below to ask.
