...
> **Current status: Module 08 is the highest module with real content.** Modules 01 through 08 have a real exercise and gate; Module 09 is still a design-complete skeleton with no authored exercise yet. Watch `docs/build-log/` for progress, or reach out using the contact method below to ask.
