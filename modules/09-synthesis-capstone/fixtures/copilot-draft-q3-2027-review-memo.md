# Draft: pre-meeting memo for Molly Jensen, Q3 2027

*Simulation only. This is a fictional Copilot output built for this workshop. Nothing in this
document describes a real client, a real account, or real financial, legal, or accounting guidance.
Kellerman & Castle operates in no real regulatory regime; nothing here is calibrated to one. Reusing
this format against a real client's real account is your own regulated activity, not something this
workshop can vouch for.*

*Drafted by Copilot at a colleague's request, ahead of Molly Jensen's Q3 2027 review meeting. Dalton
has asked for this checked line by line before it goes any further, the same way every AI-drafted
