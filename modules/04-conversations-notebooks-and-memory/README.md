...
**Deliberate cross-domain placement, not a gap:** this module also covers AB-730 bullet 3.2.3 ("describe how Copilot uses memory and instructions"), which sits in Domain 3 on the exam outline. It's taught here because it fits the conversation-hygiene theme better than Domain 3's document-drafting modules - see `docs/workshop-design.md` §7's coverage matrix for the full reasoning. If you're looking for privacy/security material and expected it here instead: that's Module 02, not this one.
...
The learner's conversation organization, closed-set answers, and instructions text satisfy Tier 1's checklist, and Tier 2's rubric confirms the instructions are specific, per the gate above.
